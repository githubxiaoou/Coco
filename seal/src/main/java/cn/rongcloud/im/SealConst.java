...
public class SealConst {
    ...
    public static final String SEALTALK_USER_ID = "userid";// app服务器id   对应登录接口返回user_id字段
    public static final String SEALTALK_LOGIN_ID = "loginid";// 融云服务器id    对应登录接口返回id字段
    public static final String SEALTALK_LOGIN_NAME = "loginnickname";
    public static final String SEALTALK_MAIL = "mail";
    public static final String SEALTALK_GENDER = "gender";
    ...
    public static final String SEALTALK_UPDATE_GROUP_TITLE = "updategrouptitle";
